...
import { searchrestaurant, requestLoadrestaurants } from '../../restaurants/store/restaurant.actions';
...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  watchSearch(): void {
    of(this.searchQuery)
      ...
      .subscribe(query => this.store.dispatch(searchrestaurant({ searchQuery: query })));
  }
